    ...
    <div className="connexion">
      <motion.div
        ...
        <form className="connexion-box-form">
          <motion.div
            className="connexion-box-form-field"
            animate={isOpen ? 'closed' : 'open'}
            variants={variants1}
            transition={{ duration: 0.2 }}>
            <label for="username" className="connexion-box-form-field-label">
              Username
            </label>
            ...
            <div className="white-background-closed-wrapper">
              <div className="white-background-closed-wrapper-back">
                <motion.div
                  ...
                  variants={variants6}
                  transition={{ duration: 0.5 }}
                  className="white-background-closed-wrapper-back-button"
          ...
          <motion.div
            ...
            <label for="password" className="connexion-box-form-field-label">
              Password
            </label>
            <input
              type="password"
              name="password"
              className="connexion-box-form-field-input"></input>
          </motion.div>
          <div className="white-password" />
          <NavLink to="home">
            <motion.button
              type="button"
              className="connexion-box-form-submit"
